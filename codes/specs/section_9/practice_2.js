...
describe('practice-9-2', function () {
...
//    });
    ...
    it("body标签的子标签为table标签，创建基本的表格", function(done){
        ...
        var caption_element = table_element.children[1];
        expect(caption_element.raw).toBe("caption");
        expect(caption_element.children[0].data).toBe("工人登记表格");

        var thead_element = table_element.children[3];
        expect(thead_element.raw).toBe("thead");
        var tr_element1 = thead_element.children[1];
        ...
        var tbody_element = table_element.children[5];
        expect(tbody_element.raw).toBe("tbody");
        var tr_element2 = tbody_element.children[1];
        ...
        var tr_element3 = tbody_element.children[3];
